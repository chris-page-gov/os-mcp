...
_DEFAULT_RETRY_HINTS: Mapping[ErrorCode, str] = {
    ...
    ErrorCode.WORKFLOW_CONTEXT_REQUIRED: "Call os_ngd_init_mapping_workflow() then fetch_detailed_collections before retrying",
    ErrorCode.INVALID_COLLECTION: "Call os_ngd_init_mapping_workflow() or os_ngd_list_mapping_collections() to inspect valid collections and retry",
