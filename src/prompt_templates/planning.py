...
PLANNING_PROMPTS: Dict[str, str] = {
    "planning_generic_workflow": (
        "Goal: Plan a multi-collection OS NGD data workflow. Steps: 1) os_ngd_init_mapping_workflow(); 2) Identify relevant collections with rationale; "
    ...
    "planning_routing_enrichment": (
        "Goal: Plan routing restriction enrichment for a study area. Steps: 1) os_ngd_init_mapping_workflow(); 2) fetch_detailed_collections(['tn-fts-roadlink-1']); "
