...
DIAGNOSTICS_PROMPTS: Dict[str, str] = {
    "diagnostics_recover_invalid_collection": (
        ...
        "2) Call os_ngd_init_mapping_workflow(); 3) fetch_detailed_collections for a valid collection; 4) Re-run search_features successfully."  # noqa: E501
    ),
    "diagnostics_missing_context_then_fix": (
        ...
        "2) Call os_ngd_init_mapping_workflow(); 3) Retry fetch_detailed_collections; 4) Proceed with search_features."  # noqa: E501
    ),
}
