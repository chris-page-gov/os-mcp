...
BASIC_QUESTIONS = [
    ...
    EvaluationQuestion(
        ...
        expected=ExpectedOutcome(
            ...
            forbidden_tools=["os_ngd_init_mapping_workflow", "os_ngd_list_mapping_collections", "search_features"],
    ...
    EvaluationQuestion(
        ...
        expected=ExpectedOutcome(
            required_tools=["search_geographic_areas"],
            forbidden_tools=["os_ngd_init_mapping_workflow"],
            max_tool_calls=2,
...
INTERMEDIATE_QUESTIONS = [
    ...
    EvaluationQuestion(
        ...
        expected=ExpectedOutcome(
            required_tools=["os_ngd_init_mapping_workflow", "search_features"],
